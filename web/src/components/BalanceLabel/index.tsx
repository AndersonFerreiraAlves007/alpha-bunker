  ...
  return (
    <div className="w-[280px] bg-white rounded-lg absolute top-[162.56px] font-medium h-[73.04px]">
      <div className="flex items-center justify-between	 mx-4 mt-[9px]">
        ...
        <span>
          <CaretDown size={20} color="#777777" weight={'bold'} />
        </span>
      </div>
      <div className="flex items-center mx-4 mt-[2px]">
        {toggle ? (
          <>
            <span>
              <Eye size={15} color="#777777" weight={'bold'}  onClick={handleToggle}/>
            </span>
            <span className="text-2xl text-[#338896] font-bold mx-[5px]">
              {formatBalance(balance)}
            </span>
            <span className="text-[#3FA7B8] text-sm font-bold mt-[5px]">
              R$
            </span>
          </>
        ) : (
          <>
            <span>
              <EyeClosed size={15} color="#777777" weight={'bold'} onClick={handleToggle} />
            </span>
            <span className="text-2xl text-[#338896] font-bold mx-[5px]">
              -----
            </span>
