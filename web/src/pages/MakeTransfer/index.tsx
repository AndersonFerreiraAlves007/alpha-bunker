  ...
  return (
    <>
      ...
      <form className='flex flex-col mt-[220px] w-[280px] bg-white dark:bg-transparent p-3.5 rounded-xl  border-[1px] dark:border-[#424245]'>
        ...
        <h2 className='text-[#353535] dark:text-[#F7F7F7] mb-[6px] mt-[8px]'>Origem</h2>
        ...
        <div>
          <h2 className='mb-[6px] mt-[7px] text-[#353535] dark:text-[#F7F7F7]'>Destino</h2>
          <div className='w-full flex justify-between	'>
            <div className='w-[110px]'>
              <Input
                name='agencia'
        ...
        <button className='bg-btn-primary-base rounded-md h-[40px] text-[#FFFFFF]' onClick={handleSubmit}>
          Transferir
        </button>
      </form>
    </>
